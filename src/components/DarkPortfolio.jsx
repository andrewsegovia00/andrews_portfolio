import '../style/darkPortfolio.css'

function DarkPortfolio({toggleMode}) {
  return (
    <>
    ...
    <div className='container mt-5' id="container">
        <section className='projectSection'>
            ...
            <div className='align-items-center justify-content-center margin-2 row indiv-project'>
                <div className='mockups align-items-center d-flex justify-content-center'>
                        <img className='desktop'
                            src="../src/assets/mockups/travelBudDesktop.png" 
                        />
                        <img className='mobile'
                            src="../src/assets/mockups/travelBudMobile.png" 
                        />
                </div>
                <div className='project-info col-4'>
                    <h1 id='project-title'>Travel Bud</h1>
                    <p className='regTxtProjectDark'>Travel Bud is a comprehensive webpage designed to assist users in creating and planning their trips while effectively managing their budgets. It offers simulated budgeting features to help users estimate their expenses before embarking on their journeys. Additionally, it enables users to track their actual expenses while traveling by allowing them to add expenses and categorize their spending.</p>
                    <img src="../src/assets/images/technologyTB.png" />
                    <div className='row d-flex justify-content-around mr-6 linksContainer mt-3' id="linksContDark">
            ...
            <div className='align-items-center justify-content-center margin-2 row indiv-project'>
                ...
                <div className='mockups align-items-center d-flex justify-content-center ml-5'>
                        <img className='desktopbttle'
                            src="../src/assets/mockups/desktopBttle.png" 
                        />
                </div>
            </div>
            ...
            <div className='align-items-center justify-content-center margin-2 row indiv-project'>
                <div className='mockups align-items-center d-flex justify-content-center'>
                        <img className='desktop'
                            src="../src/assets/mockups/desktopGO.png" 
                        />
                        <img className='mobile'
                            src="../src/assets/mockups/mobileGO.png" 
                        />
                </div>
                <div className='project-info col-4'>
                    <h1 id='project-title'>Game On</h1>
                    <p className='regTxtProjectDark'>An e-commerce site powered by Stripe API, showcasing a variety of videogame products. Customers can effortlessly add and checkout items, which updates using Next.js. The website accepts secure payments via Stripe. Built with: Tailwind CSS, TypeScript & Next.js. Hosted on Netlify.</p>
                    <img src="../src/assets/images/technologyGO.png" />
                    <div className='row d-flex justify-content-around mr-6 linksContainer mt-3' id="linksContDark">
            ...
            <div className='align-items-center justify-content-center margin-2 row indiv-project'>
                <div className='project-info col-4'>
                    ...
                    <p className='regTxtProjectDark'>Web app displaying news reports on Tech, Business, Finance, and Science from apinews.org. Built with React, Tailwind CSS, fetch, promises, hooks, and Vite. Link Preview missing due to apinews.org's restrictions.</p>
                    <img  className='techBttle' src="../src/assets/images/technologyNA.png" />
                    <div className='row d-flex justify-content-around mr-6 linksContainer mt-3' id="linksContDark">
                ...
                <div className='mockups align-items-center d-flex justify-content-center ml-5'>
                        <img className='desktopbttle'
                            src="../src/assets/mockups/desktopNA.png" 
                        />
                </div>
            </div>
